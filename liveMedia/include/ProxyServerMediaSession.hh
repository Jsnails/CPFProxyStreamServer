...
private:
  ...
  //发送setup stream命令
  void SetStreamProxy(void* pStreamProxy){
	  this->m_pStreamProxy = pStreamProxy;
  };
...
private:
  ...
  void* m_pStreamProxy;				//上层的StreamProxy调用
};
...
public:
  ...
  void SetStreamProxy(void* pStreamProxy){fProxyRTSPClient->SetStreamProxy(pStreamProxy);};
